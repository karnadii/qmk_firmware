...
/*
My keyboard layout is pretty uniqe, with one encoder on the right side and an
OLED on the left side, I use the left side as a master. The master doen't have
rotary encoder, to make encoder work on the right side keyboard,I have to define
dummy ENCODERS_PAD on the left side as QMK won't allow using only one side of
encoder or OLED.
*/
